...
instead of masking the reproducibility problem by fixing parameters. \tristan{Use ``I'' or ``we'' consistently}
...
Parametric Mapping)~\cite{spm}, FSL \tristan{add ref}, and AFNI (Analysis of Functional 
...
This chapter is under review, and we aim to submit it to the Human Brain Mapping (HBM) journal by the end of Fall 2021 \tristan{update}.
