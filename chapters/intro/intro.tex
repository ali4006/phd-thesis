...
Reproducibility is regarded as a fundamental concept in scientific 
...
research is to investigate reproducibility of analysis across different 
...
numerical instability of analysis across different computing environments 
...
reanalysed in methods reproducibility. Result reproducibility is 
...
With this, over 50\% of the scientists polled believed that there is a 
significant crisis.
...
Structural neuroimaging deals with the anatomical structure of 
brain and helps in the diagnosis of brain injury and certain diseases 
such as tumor and stroke. The main software packages used for sMRI are 
...
MRI analysis which measures the anatomical connectivity between 
...
the pre-processing and statistical steps. Pre-processing steps are taken 
...
After pre-processing steps, depending on 
...
The goal of this thesis is to study the numerical stability of neuroimaging pipelines focusing on the effect
of operating system variability. For this purpose, we leverage system call interception techniques including
