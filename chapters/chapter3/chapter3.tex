\chapter{Software variability in fMRI analysis:\\ comparing between-tool and numerical errors}
\label{ch:c3}
...
\lstinputlisting[caption=Sample wrapper function (C code), label=algo:wrapper, style=customasm]{chapters/chapter3/wrapper.c}
...
moderately correlated at this precision.
  ...
  \begin{figure*}[ht]
      \begin{subfigure}[ht]{\textwidth}
        \centering
        \includegraphics[width=.75\textwidth]{chapters/chapter3/figures/bg_global_precision.pdf}
        %\caption{Standard deviation of thresholded t-statistics map on template surface}
        \end{subfigure}
        %\caption{Standard deviation of thresholded t-statistics map on template surface}
...
\begin{figure*}[ht]
      \centering
      \includegraphics[width=.6\textwidth]{chapters/chapter3/figures/sbj-std-corr-unthresh-plot.png}
